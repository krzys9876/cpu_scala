...
trait InstructionParser extends BaseParser[Instruction]:
  ...
  private def decodeLD(mnemonic: String, op1: Operand, op2: Operand): Instruction =
    (mnemonic, op1, op2) match
      ...
      case ("LD", m1: OpMemory, r2: OpRegister) => INSTR_LD_MR(r2.num, m1.num)
      case ("LDZ", m1: OpMemory, r2: OpRegister) => INSTR_LDZ_MR(r2.num, m1.num)
      case ("LDNZ", m1: OpMemory, r2: OpRegister) => INSTR_LDNZ_MR(r2.num, m1.num)
